...
import DetalhesCheckin from '../pages/DetalhesCheck';
import TodosCheckins from './../pages/TodosCheck';
...
function DrawerRoutes() {
  return (
    <Drawer.Navigator initialRouteName="Check-ins para hoje">
      ...
      <Drawer.Screen name="Todos Checkins Realizados" component={TodosCheckins} />
    </Drawer.Navigator>
  );
}
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator screenOptions={{ headerShown: false }}>
        ...
        <Stack.Screen name="DetalhesCheckin" component={DetalhesCheckin} />
